...
import 'package:lifts_app/widgets.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          const IconAndDetail(Icons.location_city, 'Umlazi to Umhlanga'),
          Consumer<ApplicationState>(
          ...
          const Header("Wanna Share a ride?"),
          Consumer<ApplicationState>(
            ...
            builder: (context, appState, _) => Column(
              ...
              children: [
                ...
                if (appState.loggedIn) ...[
                  ...
                  const Header('Contact the Driver'),
                  GuestBook(
                    addMessage: (message) =>
...
class ApplicationState extends ChangeNotifier {
  ...
  static Map<String, dynamic> defaultValues = <String, dynamic>{
    ...
    'call_to_action': 'Driving from Umlazi to Umhlanga @7am',
  };
      ...
      default:
        return Padding(
          ...
          child: Row(
            children: [
              StyledButton(
                onPressed: () => ApplicationState()._attendees++,
                child: const Text('YES'),
              ),
              const SizedBox(width: 8),
              StyledButton(
